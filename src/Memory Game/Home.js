...
export const Home = () => {
  return (
    <>
      ...
      <p style={{ fontSize: "3vw", color:"gray"}}>In this website I present my last project in React.js</p>
      <h2 style={{ color:"gray" }}>portfilio</h2>
      <h3 style={{ color:"gray" }}>Tic Tac Toe</h3>
      <p style={{ fontSize: "3vw", padding: "0 20vw", textAlign: "left",color:"gray" }}>
        in{" "}
      ...
      <p style={{ fontSize: "3vw", padding: "0 20vw", textAlign: "left",color:"gray" }}>
        ...
        <br /> because any time you flip the wrong match the counter count and your
        score is decreased.
      </p>
    </>
  );
